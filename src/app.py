...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills and friendly competitive play",
        "schedule": "Wednesdays, Fridays, 4:30 PM - 6:00 PM",
        "max_participants": 18,
    ...
    "Music Ensemble": {
        "description": "Rehearse instrumental and vocal pieces for performances",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["charlotte@mergington.edu", "elijah@mergington.edu"]
    },
    "Science Club": {
        "description": "Engage in experiments, research, and STEM challenges",
